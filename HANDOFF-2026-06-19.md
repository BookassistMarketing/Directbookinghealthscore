...
- **Translation QA** — German `Sie` and French `vous` translations across the 5 blog posts were written by Claude, not a native reviewer. Worth a quick local read-through before the last three posts publish (29 Jun → 13 Jul).
