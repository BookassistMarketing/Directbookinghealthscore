        ...
        <div ref={heroWrapRef} className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-7 space-y-7 sm:space-y-8 z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2 print:hidden">
              ...
              {/* Revenue Simulator — mobile only; on desktop it lives in the header pills */}
              <button
                onClick={() => router.push(`${localePrefix(language)}/revenue-simulator`)}
                className="sm:hidden inline-flex items-center justify-center gap-2 bg-brand-accent text-white px-7 py-4 rounded-full text-sm font-black uppercase tracking-widest shadow-xl hover:shadow-2xl transition-all w-full"
              >
                <EditableText id="home.hero.cta3" defaultText={l.cta3} as="span" />
              </button>
            </div>
          </div>
