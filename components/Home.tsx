          ...
          <div className="lg:col-span-7 space-y-7 sm:space-y-8 z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2 print:hidden">
              ...
              <button
                ...
                className="group inline-flex items-center justify-center gap-2 bg-brand-blue text-white px-7 py-4 rounded-full text-sm font-black uppercase tracking-widest shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all w-full sm:w-auto"
              >
