...
export const ConsentModal: React.FC<ConsentModalProps> = ({ onAccept, onDecline }) => {
  ...
  const labels: Record<Language, {
    ...
    en: {
      ...
      body: 'You are about to interact with an AI system. Your website URL and audit answers will be processed by Google Gemini (our AI partner) to generate your tailored analysis. We do not store them. Do you accept and continue?',
    ...
    it: {
      ...
      body: "Stai per interagire con un sistema di intelligenza artificiale. L'URL del tuo sito e le risposte dell'audit saranno elaborati da Google Gemini (il nostro partner AI) per generare la tua analisi personalizzata. Non li conserviamo. Accetti e vuoi continuare?",
    ...
    es: {
      ...
      body: 'Estás a punto de interactuar con un sistema de inteligencia artificial. La URL de tu sitio y las respuestas de la auditoría serán procesadas por Google Gemini (nuestro socio de IA) para generar tu análisis personalizado. No las almacenamos. ¿Aceptas y quieres continuar?',
    ...
    pl: {
      ...
      body: 'Za chwilę wejdziesz w interakcję z systemem AI. Adres URL Twojej strony i odpowiedzi z audytu będą przetwarzane przez Google Gemini (naszego partnera AI) w celu wygenerowania spersonalizowanej analizy. Nie przechowujemy ich. Czy akceptujesz i chcesz kontynuować?',
    ...
    fr: {
      ...
      body: "Vous êtes sur le point d'interagir avec un système d'IA. L'URL de votre site web et les réponses de l'audit seront traitées par Google Gemini (notre partenaire IA) pour générer votre analyse personnalisée. Nous ne les conservons pas. Acceptez-vous et souhaitez-vous continuer ?",
    ...
    de: {
      ...
      body: 'Sie sind dabei, mit einem KI-System zu interagieren. Die URL Ihrer Website und Ihre Audit-Antworten werden von Google Gemini (unserem KI-Partner) verarbeitet, um Ihre individuelle Analyse zu erstellen. Wir speichern sie nicht. Akzeptieren Sie und möchten Sie fortfahren?',
    ...
    cs: {
      heading: 'Než začneme',
      body: 'Chystáte se interagovat se systémem AI. URL vašeho webu a odpovědi z auditu budou zpracovány společností Google Gemini (naším AI partnerem) za účelem vytvoření vaší přizpůsobené analýzy. Neukládáme je. Souhlasíte a chcete pokračovat?',
