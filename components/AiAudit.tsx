...
const labelsMap: Record<Language, {
  ...
  en: {
    ...
    loadingSub: "Checking structured data, crawlability, semantic coverage, booking pathways and more. This can take up to 30 seconds on complex sites — please don't refresh.",
  ...
  it: {
    ...
    loadingSub: 'Controllo dati strutturati, crawlability, copertura semantica, percorsi di prenotazione e altro. Sui siti più complessi può richiedere fino a 30 secondi — non aggiornare la pagina.',
  ...
  es: {
    ...
    loadingSub: 'Comprobando datos estructurados, rastreabilidad, cobertura semántica, rutas de reserva y más. En sitios complejos puede tardar hasta 30 segundos — no recargues la página.',
  ...
  pl: {
    ...
    loadingSub: 'Sprawdzamy dane strukturalne, indeksowalność, pokrycie semantyczne, ścieżki rezerwacji i więcej. W przypadku złożonych witryn może to potrwać do 30 sekund — prosimy nie odświeżać strony.',
  ...
  fr: {
    ...
    loadingSub: "Vérification des données structurées, de la crawlabilité, de la couverture sémantique, des parcours de réservation et plus encore. Sur les sites complexes, cela peut prendre jusqu'à 30 secondes — merci de ne pas actualiser la page.",
  ...
  de: {
    ...
    loadingSub: 'Wir prüfen strukturierte Daten, Crawlbarkeit, semantische Abdeckung, Buchungspfade und mehr. Bei komplexen Websites kann dies bis zu 30 Sekunden dauern — bitte aktualisieren Sie die Seite nicht.',
  ...
  cs: {
    ...
    loadingSub: 'Kontrolujeme strukturovaná data, indexovatelnost, sémantické pokrytí, rezervační cesty a další. U složitějších webů to může trvat až 30 sekund — prosíme, neobnovujte stránku.',
