...
export const FullResults: React.FC<FullResultsProps> = ({ questions, answers, analysis, analysisLoading, analysisError, onReset, siteUrl }) => {
  ...
  const statusMap: Record<Language, any> = {
    ...
    pl: { critical: "Stan Krytyczny", risk: "Ryzyko Cyfrowe", optimized: "Zoptymalizowany", subCritical: "Wysoce narażony na dominację OTA.", subRisk: "Brak automatyzacji generującej zyski.", subOpt: "Dobre wyniki w zestawieniu ze standardami branżowymi.", analyzing: "AI analizuje Twój stos technologiczny..." },
    fr: { critical: "État Critique", risk: "Risque Numérique", optimized: "Optimisé", subCritical: "Hautement vulnérable à la domination des OTA.", subRisk: "Manque d'automatisation génératrice de profits.", subOpt: "Bonnes performances par rapport aux références du secteur.", analyzing: "L'IA analyse votre stack technologique..." },
    de: { critical: "Kritischer Zustand", risk: "Digitales Risiko", optimized: "Optimiert", subCritical: "Hochgradig anfällig für die OTA-Dominanz.", subRisk: "Profitfördernde Automatisierung fehlt.", subOpt: "Gute Leistung im Vergleich zu Branchen-Benchmarks.", analyzing: "Die KI analysiert Ihren Tech-Stack..." },
    cs: { critical: "Kritický stav", risk: "Digitální riziko", optimized: "Optimalizováno", subCritical: "Vysoce zranitelný vůči dominanci OTA.", subRisk: "Chybí automatizace generující zisk.", subOpt: "Dobrý výkon ve srovnání s oborovými benchmarky.", analyzing: "AI analyzuje váš technologický stack..." }
  };
  ...
  const labelsMap: Record<Language, any> = {
    ...
    fr: { auditComplete: "AUDIT TERMINÉ", passing: "Contrôles Réussis", gaps: "Lacunes Critiques", aiTitle: "Évaluation Stratégique IA", ctaTitle: "Visitez bookassist.org pour améliorer votre Tech Score dès aujourd'hui", downloadFull: "Télécharger l'Évaluation Stratégique IA Complète", retake: "Refaire l'Audit", book: "Réserver une Consultation", generating: "Exportation...", reportFor: "Rapport pour" },
    de: { auditComplete: "AUDIT ABGESCHLOSSEN", passing: "Bestandene Prüfungen", gaps: "Kritische Lücken", aiTitle: "KI-Strategiebewertung", ctaTitle: "Besuchen Sie bookassist.org, um Ihren Tech Score noch heute zu verbessern", downloadFull: "Vollständige KI-Strategiebewertung herunterladen", retake: "Audit wiederholen", book: "Beratung buchen", generating: "Export läuft...", reportFor: "Bericht für" },
    cs: { auditComplete: "AUDIT DOKONČEN", passing: "Úspěšné kontroly", gaps: "Kritické mezery", aiTitle: "Strategické hodnocení AI", ctaTitle: "Navštivte bookassist.org a vylepšete svůj Tech Score ještě dnes", downloadFull: "Stáhnout úplné strategické hodnocení AI", retake: "Opakovat audit", book: "Rezervovat konzultaci", generating: "Exportování...", reportFor: "Zpráva pro" }
  };
