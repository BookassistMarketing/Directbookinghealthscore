---
title: "The 18% Shift: Travellers Are Moving From OTAs to Direct Booking — Are You Capturing Them?"
date: "2026-06-22"
excerpt: "Eighteen percent of OTA-originated travellers now book directly. The figure is up 3.3 points in a year — but only if your direct booking surface is ready to convert them."
metaDescription: "Direct booking conversion is rebounding from OTAs. What hoteliers must do to capture the 18% of travellers shifting away from Booking.com and Expedia in 2026."
...
[Bookassist's Booking Platform](https://bookassist.org/booking-platform) handles the conversion surface end to end: rate parity monitoring, mobile-first booking flow, room differentiation, abandoned-booking recovery, and integration with the rest of your direct-booking stack so the guest experience reads as one continuous journey. Hotels typically see a direct-booking conversion rate above 15% after onboarding.
